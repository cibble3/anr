...
class FurnituresControllerTest < ActionController::TestCase
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post :create, furniture: { available: @furniture.available, description: @furniture.description, image: @furniture.image, name: @furniture.name, price: @furniture.price }
    end
  ...
  test "should update furniture" do
    put :update, id: @furniture, furniture: { available: @furniture.available, description: @furniture.description, image: @furniture.image, name: @furniture.name, price: @furniture.price }
    assert_redirected_to furniture_path(assigns(:furniture))
  end
